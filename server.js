...
const ajouterArt = require('./server/routes/cours/ajouterArt')
const consulterArt = require('./server/routes/cours/consulterArt')
const listerArticles = require ('./server/routes/cours/listerArticles')
const suprimerArt = require ('./server/routes/cours/suprimerArt')
const updateArt = require ('./server/routes/cours/updateArt')
